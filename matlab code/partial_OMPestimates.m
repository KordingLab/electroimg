function [Supp,Coef,Yrec,Errs,L0norm,Depth] = partial_OMPestimates(y,normtol,kmax,visualize)
...
for i=1:length(zcoord)
    ...
    [Supp{i},Coef{i},Yrec(:,i)] = sparse_chargedist(y,vcoord2,...
